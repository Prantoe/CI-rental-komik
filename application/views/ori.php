    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="site-wrap">
                        ...
                        <div class="mx-auto text-center">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                                    ...
                                    <li>
                                        <a href="#courses-section" class="nav-link">Comics</a>
                                    </li>
                                    <li>
                                        <a href="#programs-section" class="nav-link">Maps</a>
                                    </li>
                                    <li>
                                        <a href="#teachers-section" class="nav-link">Portofolio</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="intro-section" id="home-section">
                ...
                <div
                    class="slide-1"
                    style="background-image: url('assets/front/images/hero_1.jpg');"
                            ...
                            <div class="col-12">
                                <div class="row align-items-center">
                                    <div class="col-lg-8 mb-4">
                                        <h1 data-aos="fade-up" data-aos-delay="100">Subscribe for get notification update! and helpful tips and tricks.</h1>
                                        ...
                                        <p data-aos="fade-up" data-aos-delay="300">
                                            <a href="Home" class="btn btn-primary py-3 px-6 btn-pill">Subscribe Now</a>
                                        </p>
